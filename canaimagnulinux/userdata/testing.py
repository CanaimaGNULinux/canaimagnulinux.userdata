...
class Fixture(PloneSandboxLayer):
    ...
    ./bin/test -s canaimagnulinux.userdata --list-tests
    """
    ...
    def setUpZope(self, app, configurationContext):
        ...
        z2.installProduct(app, 'canaimagnulinux.userdata')
    ...
    def setUpPloneSite(self, portal):
        ...
        self.applyProfile(portal, 'canaimagnulinux.userdata:default')

    def tearDownZope(self, app):
        # Uninstall products installed above
        z2.uninstallProduct(app, 'canaimagnulinux.userdata')
...
INTEGRATION_TESTING = IntegrationTesting(
    bases=(FIXTURE,),
    name='canaimagnulinux.userdata:Integration'
)
...
FUNCTIONAL_TESTING = FunctionalTesting(
    bases=(FIXTURE,),
    name='canaimagnulinux.userdata:Functional'
)
...
ROBOT_TESTING = FunctionalTesting(
    ...
    name='canaimagnulinux.userdata:Robot',
)
